...
class BraTS2019(Dataset):
    ...
    def __init__(self, base_dir=None, datalist_path=None, split='train', num=None, transform=None):
        self._base_dir = base_dir
        self.datalist_dir = datalist_path
        self.transform = transform
        self.sample_list = []

        train_path = self.datalist_dir+'train.txt'
        test_path = self.datalist_dir+'val.txt'
    ...
    def __getitem__(self, idx):
        ...
        # h5f = h5py.File(self._base_dir+image_name+"/mri_norm2.h5", 'r')  # For the LA Dataset training
